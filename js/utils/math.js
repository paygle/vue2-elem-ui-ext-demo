...
/* SimpleMath precision utils*/
define(function(require, exports, module) {
  'use strict';
  function SimpleMath(){}

  // 除法
  SimpleMath.prototype.div = function(arg1, arg2, limit) {
  ...
  //乘法 
  var multi = SimpleMath.prototype.multi = function (arg1, arg2, limit) {
    arg1 = typeof arg1 === 'undefined' ? 0 : arg1; 
    arg2 = typeof arg2 === 'undefined' ? 0 : arg2;
  ...
  //加法  
  SimpleMath.prototype.add = function (arg1, arg2, limit) {
    arg1 = typeof arg1 === 'undefined' ? 0 : arg1; 
    arg2 = typeof arg2 === 'undefined' ? 0 : arg2;
    var r1, r2, m, ret;
    limit = typeof limit === 'undefined' ? -1 : limit;
  ...
  //减法  
  SimpleMath.prototype.sub = function (arg1, arg2, limit) {
    arg1 = typeof arg1 === 'undefined' ? 0 : arg1; 
    arg2 = typeof arg2 === 'undefined' ? 0 : arg2;
    var r1, r2, m, n, ret;
    limit = typeof limit === 'undefined' ? -1 : limit;
  ...
  // 精度
  SimpleMath.prototype.precision = function (numb, lmt){
