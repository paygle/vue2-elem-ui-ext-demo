define(['vue', 'ELEMENT', 'pageheader', 'util', 'data', 'policy.sales', 'policy.main', 'policy.insured', 'policy.vhlowner', 'policy.veh', 'policy.cvrg'], function(Vue, ELEMENT, pageheader, util, data, salesModule, mainModule, insuredModule, vhlownerModule, vehModule, cvrgModule) {
	Vue.use(ELEMENT);
